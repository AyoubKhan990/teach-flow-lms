...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)] pt-24 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
      <Helmet>
        <title>Contact Us - TeachFlow LMS</title>
        <meta
          name="description"
          content="Get in touch with TeachFlow LMS. Connect with us on social media or send us a message."
        />
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Gulgasht Colony, Multan</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a
                    href="mailto:ayoubkhan427990@gmail.com"
                    className="text-gray-600 hover:text-indigo-600 transition-colors"
                  >
                    ayoubkhan427990@gmail.com
                  </a>
                </div>
              </div>
            </div>
