...
const About = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white text-gray-900 py-20 px-6 border-b border-gray-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            TeachFlow LMS is your AI-powered companion that turns passive watching
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-[color:var(--tf-bg)] p-6 rounded-xl border border-[color:var(--tf-border)]">
            ...
            <div className="bg-[color:var(--tf-bg)] p-6 rounded-xl border border-[color:var(--tf-border)] mt-0 sm:mt-8">
      ...
      <div className="bg-[color:var(--tf-bg)] py-20 border-t border-[color:var(--tf-border)]">
      ...
      <div className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
            ...
            harder. Start your journey with TeachFlow LMS today.
          </p>
