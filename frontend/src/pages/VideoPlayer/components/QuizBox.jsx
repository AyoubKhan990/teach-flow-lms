...
const QuizBox = ({ quiz, loading, onRetry, onQuizComplete }) => {
  ...
  if (loading) {
    return (
      <div className="p-5 border border-[color:var(--tf-border)] rounded-2xl bg-[color:var(--tf-surface)] shadow-[var(--tf-shadow-sm)] min-h-[200px] flex flex-col items-center justify-center">
  ...
  if (!quiz || quiz.length === 0) {
    return (
      <div className="p-5 border border-[color:var(--tf-border)] rounded-2xl bg-[color:var(--tf-surface)] shadow-[var(--tf-shadow-sm)] min-h-[200px] flex flex-col items-center justify-center">
        <h3 className="text-xl font-extrabold text-[color:var(--tf-text)] mb-6 flex items-center gap-2">
  ...
  return (
    <div className="p-5 border border-[color:var(--tf-border)] rounded-2xl bg-[color:var(--tf-surface)] shadow-[var(--tf-shadow-sm)] min-h-[200px]">
      ...
      <div className="space-y-6">
        {quiz.map((q, i) => (
          <div
            key={i}
            className="p-4 bg-[color:var(--tf-bg)] rounded-xl border border-[color:var(--tf-border)]"
          >
