...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)] p-6 lg:p-10">
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-extrabold text-[color:var(--tf-text)]">
              Dashboard
            </h1>
            <p className="text-[color:var(--tf-text-muted)] mt-1">
              Welcome back, {data?.user?.name}! Here's your learning progress.
            </p>
          </div>
          <div className="text-sm text-[color:var(--tf-text-subtle)]">
