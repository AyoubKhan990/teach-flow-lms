...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        <div className="bg-[color:var(--tf-surface)] rounded-2xl shadow-[var(--tf-shadow-md)] border border-[color:var(--tf-border)] overflow-hidden">
          {/* Header Background */}
            ...
            <div className="absolute -bottom-12 left-8">
              <div className="relative group">
                <img
                  src={user.picture}
                  alt="profile"
                  className="w-24 h-24 rounded-full border-4 border-[color:var(--tf-surface)] shadow-[var(--tf-shadow-sm)] object-cover bg-[color:var(--tf-surface)]"
                />
          ...
          <div className="pt-16 pb-8 px-8">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-2xl font-bold text-[color:var(--tf-text)] flex items-center gap-2">
                  {user.name}
                  {!isEditing && (
                    <button
                      onClick={() => setIsEditing(true)}
                      className="text-[color:var(--tf-text-subtle)] hover:text-[color:var(--tf-primary)] transition-colors p-1"
                      title="Edit Profile"
                    >
                      <Edit2 size={16} />
                    </button>
                ...
                <p className="text-[color:var(--tf-text-muted)] flex items-center gap-1.5 mt-1">
                  <Mail size={14} />
                  {user.email}
                </p>
              </div>
