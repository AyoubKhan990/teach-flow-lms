...
export default function Feed() {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)]">
      ...
      <div className="bg-[color:var(--tf-surface)] shadow-[var(--tf-shadow-sm)] border-b border-[color:var(--tf-border)] sticky top-0 z-10">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {items.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-semibold text-[color:var(--tf-text)] mb-2">
              No Content Found
            </h2>
