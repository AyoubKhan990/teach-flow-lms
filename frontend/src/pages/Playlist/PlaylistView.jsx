...
export default function PlaylistView() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[color:var(--tf-bg)] p-8">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[color:var(--tf-bg)] flex flex-col items-center justify-center p-4">
        <p className="text-red-600 mb-4">{error}</p>
        <button
          onClick={() => navigate(-1)}
          className="px-4 py-2 bg-[color:var(--tf-surface)] border border-[color:var(--tf-border)] rounded-lg hover:bg-[color:var(--tf-surface-muted)]"
        >
          Go Back
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)] pb-12">
      {/* Header */}
      <div className="bg-[color:var(--tf-surface)] border-b border-[color:var(--tf-border)] sticky top-0 z-10">
