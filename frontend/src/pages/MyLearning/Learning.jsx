...
export default function Learning() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[color:var(--tf-bg)] p-6 lg:p-10 space-y-8">
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[color:var(--tf-bg)] flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[color:var(--tf-bg)] pb-20">
      {/* Hero Header */}
      <div className="bg-[color:var(--tf-surface)] border-b border-[color:var(--tf-border)] pt-10 pb-16 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-[color:var(--tf-text)] mb-4">
            My Learning
          </h1>
          <p className="text-[color:var(--tf-text-muted)] text-lg max-w-2xl">
