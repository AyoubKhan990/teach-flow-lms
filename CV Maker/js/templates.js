// Template Definitions with Format Types
const templates = [
...
// Random avatar images from UI Faces / Unsplash style placeholders
const avatarImages = [
...
// Generate preview HTML based on format
...
// Expose renderTemplates globally
window.renderTemplates = function (filter = 'all') {
    ...
    // Render top 4 for featured in dashboard
...
function selectTemplate(id) {
    if (window.navigateTo && window.setTemplate) {
        ...
        console.error('Navigation or Template Setter not found');
